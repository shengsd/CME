...
**
** This file is part of the QuickFIX HSFIX20 Engine
**
...
namespace HSFIX20
{
//	FIX版本支持	固定,不是从数据词典获得,由引擎本身支持版本而定
//const char BeginString_STEP[]  = "STEP";
...
const char BeginString_FIX50[] = "FIXT.1.1";
