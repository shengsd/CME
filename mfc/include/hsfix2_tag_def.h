/****************************************************************************
  ...
  20160303	zhouwh	根据FIX5.0协议字段定义修改补充TAG值定义
**/

#ifndef __HSFIX20_TAG_DEF__H__
#define __HSFIX20_TAG_DEF__H__
...
namespace FIELD
{
	enum Field
	{
		...
		,SecurityIDSource = 22
		,IOIid = 23
		,IOIOthSvc = 24	// no longer used[fix5.0]
		,IOIQltyInd = 25
		,IOIRefID = 26
		,IOIQty = 27
		,IOITransType = 28
		...
		,Price = 44
		,RefSeqNum = 45
		,RelatdSym = 46	// no longer used[fix5.0]
		,Rule80A = 47	// no longer used[fix5.0]
		,SecurityID = 48
		,SenderCompID = 49
		,SenderSubID = 50
		,SendingDate = 51	// no longer used[fix5.0]
		,SendingTime = 52
		,Quantity = 53
		,Side = 54
		,Symbol = 55
